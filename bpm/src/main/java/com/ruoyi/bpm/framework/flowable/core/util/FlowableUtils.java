...
public class FlowableUtils {
    ...
    private static Integer getProcessInstanceStatus(Map<String, Object> processVariables) {
        return (Integer) processVariables.get(BpmnModelConstants.PROCESS_INSTANCE_VARIABLE_STATUS);
    }
    ...
    public static Map<String, Object> filterProcessInstanceFormVariable(Map<String, Object> processVariables) {
        processVariables.remove(BpmnModelConstants.PROCESS_INSTANCE_VARIABLE_STATUS);
    ...
    public static Map<String, List<Long>> getStartUserSelectAssignees(ProcessInstance processInstance) {
        return (Map<String, List<Long>>) processInstance.getProcessVariables().get(
                BpmnModelConstants.PROCESS_INSTANCE_VARIABLE_START_USER_SELECT_ASSIGNEES);
    }
    ...
    public static Integer getTaskStatus(TaskInfo task) {
        return (Integer) task.getTaskLocalVariables().get(BpmnModelConstants.TASK_VARIABLE_STATUS);
    }
    ...
    public static String getTaskReason(TaskInfo task) {
        return (String) task.getTaskLocalVariables().get(BpmnModelConstants.TASK_VARIABLE_REASON);
    }
    ...
    public static Map<String, Object> filterTaskFormVariable(Map<String, Object> taskLocalVariables) {
        taskLocalVariables.remove(BpmnModelConstants.TASK_VARIABLE_STATUS);
        taskLocalVariables.remove(BpmnModelConstants.TASK_VARIABLE_REASON);
