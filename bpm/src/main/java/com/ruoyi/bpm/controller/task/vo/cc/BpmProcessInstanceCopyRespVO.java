package com.ruoyi.bpm.controller.task.vo.cc;
...
public class BpmProcessInstanceCopyRespVO {
    ...
    @Schema(description = "抄送主键", required=true, example = "1024")
    private Long id;

    @Schema(description = "发起人编号", required=true, example = "888")
    private Long startUserId;
    @Schema(description = "发起人昵称", required=true, example = "芋道")
    private String startUserName;

    @Schema(description = "流程实例编号", required=true, example = "A233")
