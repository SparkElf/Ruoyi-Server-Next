...
public class BpmProcessDefinitionRespVO {
    ...
    @Schema(description = "流程标识",required=true, example = "yudao")
    private String key;

    @Schema(description = "流程图标",required=true, example = "https://www.iocoder.cn/yudao.jpg")
    private String icon;
    ...
    public static class UserTask {
        ...
        @Schema(description = "任务标识",required=true, example = "sudo")
        private String id;

        @Schema(description = "任务名",required=true, example = "王五")
        private String name;
